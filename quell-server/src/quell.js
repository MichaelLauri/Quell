...
class QuellCache {
  ...
  /**
   * generateId generates a unique ID to refer to an item
   *  in cache. Each id concatenates the object type with an
   * id property (item.id or item._id). If no id property
   *  is present, the item is declared uncacheable.
